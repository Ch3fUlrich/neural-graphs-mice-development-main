...
:func:`ngmd.data_generation.generate_network_summaries`.
"""
...
from ngmd.data_generation import generate_network_summaries  # noqa: F401
...
def main(data_dir, save_dir, sim_type, connect_thresh):
    generate_network_summaries(data_dir, save_dir, connect_thresh=connect_thresh, sim_type=sim_type)
