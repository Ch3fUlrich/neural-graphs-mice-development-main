...
# Set up other variables in configs/config.yaml

#Run the desired commands
#########################
python scripts/data_generation/precompute_sttc_arrays.py --data_dir $NGMD_DATA --n_sessions_in_parallel $n_sessions_in_parallel
