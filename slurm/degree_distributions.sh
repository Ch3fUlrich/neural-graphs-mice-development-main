...
#Name of the job
#SBATCH --job-name=degree_distributions
...
#working directory
#SBATCH --output=logs/degree_distributions.o
#SBATCH --error=logs/degree_distributions.e
...
##########################################
array_job_cmds=slurm/degree_distributions_cmds.sh
